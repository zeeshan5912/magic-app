        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    'https://magicai.keydevsdemo.com/api/aiwriter/generator/custom-generation-eQao5n/workbook',
                    {
                        headers: {
                                    ...
                                    <div className="col-12 d-flex flex-column ">
                                        ...
                                        <div className="col-12 mb-3">
                                            ...
                                            <textarea 
                                                className="form-control" 
                                                rows="4" 
                                                placeholder="Description for prompt"
                                                value={userDescription}
                                                onChange={(e) => setUserDescription(e.target.value)}
                                            />
                                        </div>
                                        ...
                                        <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Description Second</label>
                                            <textarea 
                                                className="form-control" 
                                                rows="4" 
                                                placeholder="Description Second for prompt"
                                                value={userDescription}
                                                onChange={(e) => setUserDescription(e.target.value)}
                                            />
                                        </div>
