...
const ProductNameGen = () => {
    const [title, setTitle] = useState('');
    const [description, setDescription] = useState('');
    const [userDescription, setUserDescription] = useState('');
    const [rewrittenText, setRewrittenText] = useState('');
    const [messageId, setMessageId] = useState(null);
    const [articleTitle, setArticleTitle] = useState('Seed Words (Seperate With Comma)');
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    'https://magicai.keydevsdemo.com/api/aiwriter/generator/product_name/workbook',
                    {
                        headers: {
                            ...
                            <div className="row pt-5">
                                ...
                                <div class="col-12 form-control h-auto mb-3">
                                    ...
                                    <div class="col-12 d-flex flex-column ">
                                        ...
                                        <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Seed Words (Seperate With Comma)</label>
                                            <input 
                                                type="text" 
                                                className="form-control" 
                                                value={articleTitle}
