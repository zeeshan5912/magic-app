...
const FAQGenerator      = () => {
    ...
    const [articleTitle, setArticleTitle] = useState('Title (Faq Question)');
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    'https://magicai.keydevsdemo.com/api/aiwriter/generator/faq_generator/workbook',
                    {
                        headers: {
                                ...
                                <div className="col-12 form-control h-auto mb-3">
                                    ...
                                    <div className="col-12 d-flex flex-column ">
                                        ...
                                        <div className="col-12 mb-3">
                                         ...
                                         <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Title (Faq Question)</label>
                                            <input 
                                                type="text" 
                                                className="form-control" 
                                                value={articleTitle}
