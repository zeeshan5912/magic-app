...
const EmailAnswerGenerator      = () => {
    const [title, setTitle] = useState('');
    const [description, setDescription] = useState('');
    const [userDescription, setUserDescription] = useState('');
    const [rewrittenText, setRewrittenText] = useState('');
    const [messageId, setMessageId] = useState(null);
    const [articleTitle, setArticleTitle] = useState('Subject of Email');
    const [focusKeywords, setFocusKeywords] = useState('Keywords (Separate with comma)');
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    'https://magicai.keydevsdemo.com/api/aiwriter/generator/email_answer_generator/workbook',
                    {
                        headers: {
                            ...
                            <div className="row pt-5">
                                ...
                                <div className="col-12 form-control h-auto mb-3">
                                    ...
                                    <div className="col-12 d-flex flex-column ">
                                        ...
                                        <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Description (Receieved Email)</label>
                                            <textarea 
                                                className="form-control" 
                                                rows="4" 
                                                placeholder="Description (Receieved Email)"
                                                value={userDescription}
                                                onChange={(e) => setUserDescription(e.target.value)}
                                            />
                                        </div>
                                         ...
                                         {/* <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Subject of Email</label>
                                            <input 
                                                type="text" 
                                                className="form-control" 
                                                value={articleTitle}
...
export default EmailAnswerGenerator;
