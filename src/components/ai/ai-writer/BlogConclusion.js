...
const BlogConclusion = () => {
    ...
    const [articleTitle, setArticleTitle] = useState('Title of blog text');
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    'https://magicai.keydevsdemo.com/api/aiwriter/generator/blog_conclusion/workbook',
                    {
                        headers: {
                            ...
                            <div className="row pt-5">
                                ...
                                <div className="col-12 form-control h-auto mb-3">
                                    ...
                                    <div className="col-12 d-flex flex-column ">
                                        ...
                                        <div className="col-12 mb-3">
                                            <label htmlFor="" className="form-label">Title of blog text</label>
                                            <input 
                                                type="text" 
                                                className="form-control" 
                                                value={articleTitle}
