             ...
             <div className="content-wrapper" style={{ backgroundColor: 'white' }}  >
                        ...
                        <div className="row pb-4 mt-5">
                            <div className="col-lg-6">
                                <h3>AI File Chat</h3>
                                <p>Simply upload a PDF, find specific information. extract key insights or summarize the
                                    entire document.</p>
                            </div>
                                                    ...
                                                    <a className="navLink" href="/">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="px-1 mt-1">
                                                                <h6 className="fs-6 mb-0">File Analyzer Chat</h6>
                                                                <p className="card-text mb-0"
                                                                  style={{ fontSize: '13px', marginTop: '4px' }}><small
                                                                        className="text-muted">1 week ago</small></p>
                                                                <a className="text-black" href="asas">My-pdf.pdf</a>
                                                            </div>
                                                        </div>
...
>
                                            <button
                                                className="btn btn-primary w-100 d-flex justify-content-center align-items-center uploadBtn" style={{ borderRadius: '20px' }}>
