...
//                 const response = await fetch('https://magicai.keydevsdemo.com/api/aiwriter/generator/ai_vision/workbook', {
//                     method: 'GET',
//                     headers: {
...
//                 setChatData(data.category); // For category info
//                 setChatList(data.list); // For chat list
//             } catch (error) {
...
//     const openChatContainer = async (chatId) => {
//         try {
//             const token = localStorage.getItem('token');

//             const response = await fetch('https://magicai.keydevsdemo.com/api/aichat/open-chat-area-container', {
//                 method: 'POST',
//                 headers: {
//                     'Authorization': `Bearer ${token}`,
//                     'Content-Type': 'application/json'
//                 },
//                 body: JSON.stringify({ chatId }) // Send the chatId as part of the request body
//             });

//             if (!response.ok) {
//                 throw new Error('Failed to open chat container');
//             }

//             const data = await response.json();
//             console.log('Chat container opened:', data);
//             // Assuming the response includes messages
//             setMessages(data.messages || []); // Update state with messages
//         } catch (error) {
//             console.error('Error opening chat container:', error);
//         }
//     };
//   return (
//     <>
...
//                                             openChatContainer(chat.id); // Call the function to open chat
//                                         }}
//                                     >
//                                         <div className="d-flex">
//                                             <div className="px-3">
...
//                     <div key={index} className={msg.sender === 'user' ? 'sendMsg' : 'receiverMsg'}>
